...
const LandingPage = () => {
    return (
        <div className={styles['landing-page-container']}>
            <div className={styles['page-title']}>commuter course</div>
            <div className={styles['peter-planner-desc']}>
                hi there! welcome to commuter course, the perfect planning tool for Peter the Commuter any any of his friends. just enter your classes and we’ll help you find the best schedule for minimizing days on campus and time between classes.
            </div>
            <div className={styles['peter-planner-link-container']}>
                ...
                <Link to="/planner" className={styles['peter-planner-link']} src='images/petr_spaceship.png'>
                    ...
                    <div className={styles['link-text']}>go to commuter course</div>
                </Link>
            </div>
        </div>
    );     
